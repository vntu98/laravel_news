...
Route::get('change-language/{language}',                [ 'as' => 'change-language',                'uses' => 'LangController@changeLanguage' ]);
...
Route::group(['prefix' => $prefixAdmin, 'namespace' => 'Admin', 'middleware' => ['permission.admin', 'locale']], function () {
